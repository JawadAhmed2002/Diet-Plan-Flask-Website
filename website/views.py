...
def YourPlan():
    ...
    if Active_user1:
        # BMI calculater:
        BMI = float(Active_user1.weight) / (float(Active_user1.height)
                                            * float(Active_user1.height) * 0.0001)
        BMI = round(BMI, 1)
        ...
        if Active_user1.gender == 'Male':
            BMR = (10 * float(Active_user1.weight)) + (6.25 *
                                                       float(Active_user1.height)) - (5 * int(Active_user1.age)) + 5
        else:
            BMR = (10 * float(Active_user1.weight)) + (6.25 *
                                                       float(Active_user1.height)) - (5 * int(Active_user1.age)) - 161
